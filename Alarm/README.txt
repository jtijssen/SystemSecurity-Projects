...
- All aspects of the alarm have correctly been implemented. I discussed the assignment on piazza.
  In total, I spend about 5hours completing the assignment.
...
- If you have spare time in the future, what would you add to the program or do differently with regards to detecting incidents?
	- I would check for more different flags. Additionally, I would see if I could determine where the scan came from.
	  Lastly, I read that Scapy can also be used to send a scan, which would be interesting to try.
